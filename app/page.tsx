...
export default function HomePage() {
  ...
  const handleCheckout = async (productId: string) => {
    ...
    try {
      ...
      console.error(error);
      alert('Something went wrong while creating your checkout session.');
    } finally {
      setLoadingId(null);
    }
  };
      ...
      <section className="hero">
        <div className="hero-card">
          ...
          <p className="subtitle">
            Launch a polished payment experience for your products, memberships, or services using a secure Stripe-powered checkout flow.
          </p>
        ...
        <div className="hero-card mini-stat">
          <div className="mini-label">This month</div>
          <div className="mini-total">$28,400</div>
          <div className="mini-sub">Gross revenue</div>
